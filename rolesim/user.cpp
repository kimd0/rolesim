...
int User::useItem(const ItemData& item_data, int index)
{
	if ((int)item_.size() <= index)
	{
...
int User::useSkill(const SkillData& skill_data, int index)
{
	if ((int)skill_.size() <= index)
	{
